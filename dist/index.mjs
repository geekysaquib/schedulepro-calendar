  ...
  return createPortal(
    /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxs("div", { className: "tooltip-header", style: { color: staffColor }, children: [
            isBreak ? /* @__PURE__ */ jsx(Coffee, { size: 13 }) : /* @__PURE__ */ jsx(Calendar, { size: 13 }),
            reservation.title
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "tooltip-time", children: [
            formatTime12h(reservation.start_time),
            " \u2013 ",
            formatTime12h(displayEnd)
          ] }),
          reservation.description && /* @__PURE__ */ jsx("div", { className: "tooltip-desc", children: reservation.description }),
          /* @__PURE__ */ jsxs("button", { className: "tooltip-delete", onClick: onDelete, children: [
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsx("div", { className: "block-accent-bar", style: { background: staffColor } }),
          /* @__PURE__ */ jsx("div", __spreadProps(__spreadValues(__spreadValues({ ref: setNodeRef, className: "block-drag-zone" }, listeners), attributes), { children: /* @__PURE__ */ jsxs("div", { className: "block-inner", children: [
            /* @__PURE__ */ jsxs("div", { className: "block-top-row", children: [
              isBreak ? /* @__PURE__ */ jsx(Coffee, { size: 9, color: colors.title }) : /* @__PURE__ */ jsx(Calendar, { size: 9, color: colors.title }),
              /* @__PURE__ */ jsx("span", { className: "block-title", style: { color: colors.title }, children: reservation.title })
            ] }),
            reservation.description && /* @__PURE__ */ jsx("span", { className: "block-desc", style: { color: colors.desc }, children: reservation.description })
          ] }) })),
          /* @__PURE__ */ jsx("div", { className: "resize-handle", onMouseDown: handleResizeMouseDown, children: /* @__PURE__ */ jsx("div", { className: "resize-grip" }) })
        ]
      }
    ),
    showTooltip && !isDragging && !isResizing && /* @__PURE__ */ jsx(
      BlockTooltip,
      {
...
// src/components/StaffRow.tsx
import { X, Calendar as Calendar2, Coffee as Coffee2 } from "lucide-react";
  ...
  return createPortal2(
    /* @__PURE__ */ jsxs2(
      "div",
      {
        ...
        onClick: (e) => e.stopPropagation(),
        children: [
          /* @__PURE__ */ jsxs2("div", { className: "overflow-popup-header", children: [
            ...
            /* @__PURE__ */ jsx2("button", { onClick: onClose, children: /* @__PURE__ */ jsx2(X, { size: 12 }) })
          ] }),
          group.extras.map((res) => /* @__PURE__ */ jsxs2("div", { className: "overflow-item", children: [
            /* @__PURE__ */ jsx2("div", { className: "overflow-dot", style: { background: staffColor } }),
            /* @__PURE__ */ jsxs2("div", { className: "overflow-details", children: [
              /* @__PURE__ */ jsxs2("div", { className: "overflow-title", children: [
                res.type === "break" ? /* @__PURE__ */ jsx2(Coffee2, { size: 11 }) : /* @__PURE__ */ jsx2(Calendar2, { size: 11 }),
                res.title
              ] }),
              /* @__PURE__ */ jsxs2("span", { className: "overflow-time", children: [
                formatTime12h(res.start_time),
                " \u2013 ",
                formatTime12h(res.end_time)
              ] }),
              res.description && /* @__PURE__ */ jsx2("span", { className: "overflow-desc", children: res.description })
            ] }),
            /* @__PURE__ */ jsx2("button", { className: "overflow-delete", onClick: () => onDelete(res.id), children: "\xD7" })
          ] }, res.id))
        ]
      }
    ),
...
function StaffRow({
  ...
  const [openOverflow, setOpenOverflow] = useState2(null);
  const badgeRefs = useRef2(/* @__PURE__ */ new Map());
  ...
  return /* @__PURE__ */ jsxs2("div", { className: "staff-row", onClick: () => setOpenOverflow(null), children: [
    /* @__PURE__ */ jsxs2("div", { className: "staff-label", style: { borderLeft: `3px solid ${staff.color}20` }, children: [
      /* @__PURE__ */ jsx2("div", { className: "staff-avatar-ring", style: { background: `linear-gradient(135deg, ${staff.color}, ${staff.color}99)` }, children: /* @__PURE__ */ jsx2("div", { className: "staff-avatar", style: { background: staff.color }, children: staff.avatar_initials }) }),
      /* @__PURE__ */ jsxs2("div", { className: "staff-info", children: [
        /* @__PURE__ */ jsx2("span", { className: "staff-name", children: staff.name }),
        staff.role && /* @__PURE__ */ jsx2("span", { className: "staff-role", children: staff.role }),
        /* @__PURE__ */ jsxs2("span", { className: "staff-count", children: [
          reservations.filter((r) => r.type === "reservation").length,
          " appointments"
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxs2("div", { className: "row-timeline", style: { height: `${ROW_HEIGHT}px` }, children: [
      /* @__PURE__ */ jsx2("div", { className: "cells-layer", children: HOURS.map(
        (h) => MINUTES.map((m) => {
          const time = `${String(h).padStart(2, "0")}:${String(m).padStart(2, "0")}`;
          return /* @__PURE__ */ jsx2("div", { onClick: (e) => handleCellClick(e, time), style: { display: "contents" }, children: /* @__PURE__ */ jsx2(DroppableCell, { staffId: staff.id, time }) }, time);
        })
      ) }),
      /* @__PURE__ */ jsxs2("div", { className: "blocks-layer", children: [
        slot0.map((res) => /* @__PURE__ */ jsx2(
          ReservationBlock,
          {
            reservation: res,
        ...
        overflowGroups.map((group) => {
          var _a;
          return /* @__PURE__ */ jsxs2("div", { style: { position: "absolute", left: `${group.x}px`, top: 0, zIndex: 30, pointerEvents: "all" }, children: [
            /* @__PURE__ */ jsxs2(
              "button",
              {
                ref: (el) => {
            ...
            openOverflow === group.time && /* @__PURE__ */ jsx2(
              OverflowPopup,
              {
                group,
                staffColor: staff.color,
...
function TimeHeader() {
  return /* @__PURE__ */ jsxs3("div", { className: "time-header-row", children: [
    /* @__PURE__ */ jsx3("div", { className: "corner-spacer", children: /* @__PURE__ */ jsx3("span", { className: "corner-label", children: "Staff member" }) }),
    /* @__PURE__ */ jsx3("div", { className: "hour-labels", children: HOURS.map((h) => /* @__PURE__ */ jsxs3("div", { className: "hour-block", style: { width: `${CELL_WIDTH * 12}px` }, children: [
      /* @__PURE__ */ jsx3("span", { className: "hour-label", children: h === 0 ? "12:00 AM" : h < 12 ? `${h}:00 AM` : h === 12 ? "12:00 PM" : `${h - 12}:00 PM` }),
      /* @__PURE__ */ jsx3("div", { className: "minute-ticks", children: MINUTES.map((m) => /* @__PURE__ */ jsx3(
        "div",
        {
          className: `minute-tick ${m === 0 ? "major" : m === 30 ? "semi" : "minor"}`,
          style: { width: `${CELL_WIDTH}px` },
          children: m === 30 && /* @__PURE__ */ jsx3("span", { className: "minute-label", children: ":30" })
        },
        m
      )) })
    ] }, h)) })
...
import { Calendar as Calendar3, Coffee as Coffee3 } from "lucide-react";
...
function ContextMenu({
  ...
  return /* @__PURE__ */ jsxs4(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs4("div", { className: "context-menu-header", children: [
          /* @__PURE__ */ jsx4("span", { className: "context-staff", children: staffName }),
          /* @__PURE__ */ jsx4("span", { className: "context-time", children: formatTime12h(time) })
        ] }),
        /* @__PURE__ */ jsxs4("button", { className: "context-item reservation-item", onClick: onAddReservation, children: [
          /* @__PURE__ */ jsx4(Calendar3, { size: 14 }),
          "Add Reservation"
        ] }),
        /* @__PURE__ */ jsxs4("button", { className: "context-item break-item", onClick: onAddBreak, children: [
          /* @__PURE__ */ jsx4(Coffee3, { size: 14 }),
          "Add Break"
        ] })
      ]
    }
...
import { X as X2, Clock, User, AlignLeft, Tag } from "lucide-react";
...
function ReservationModal({
  ...
  const [title, setTitle] = useState3(defaultTitle);
  const [description, setDescription] = useState3("");
  const [endTime, setEndTime] = useState3(defaultEnd);
  const [selectedStaffId, setSelectedStaffId] = useState3(staffId);
  ...
  return /* @__PURE__ */ jsx5("div", { className: "modal-overlay", onClick: onClose, children: /* @__PURE__ */ jsxs5("div", { className: "modal", onClick: (e) => e.stopPropagation(), children: [
    /* @__PURE__ */ jsxs5("div", { className: "modal-header", children: [
      /* @__PURE__ */ jsxs5("div", { className: "modal-title-row", children: [
        /* @__PURE__ */ jsx5(
          "div",
          {
        ...
        /* @__PURE__ */ jsx5("button", { className: "modal-close", onClick: onClose, children: /* @__PURE__ */ jsx5(X2, { size: 16 }) })
      ] }),
      /* @__PURE__ */ jsx5("h2", { className: "modal-heading", children: type === "break" ? "Add Break" : "New Reservation" }),
      /* @__PURE__ */ jsx5("p", { className: "modal-subheading", children: date })
    ] }),
    /* @__PURE__ */ jsxs5("div", { className: "modal-body", children: [
      /* @__PURE__ */ jsxs5("div", { className: "form-group", children: [
        /* @__PURE__ */ jsxs5("label", { className: "form-label", children: [
          /* @__PURE__ */ jsx5(User, { size: 13 }),
          " Staff Member"
        ] }),
        /* @__PURE__ */ jsx5("div", { className: "staff-select-grid", children: staffList.map((s) => /* @__PURE__ */ jsxs5(
          "button",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx5("span", { className: "chip-name", children: s.name.split(" ")[0] })
            ]
          },
          s.id
        )) })
      ...
      /* @__PURE__ */ jsxs5("div", { className: "form-group", children: [
        /* @__PURE__ */ jsxs5("label", { className: "form-label", children: [
          /* @__PURE__ */ jsx5(Clock, { size: 13 }),
          " Time"
        ] }),
        /* @__PURE__ */ jsxs5("div", { className: "time-row", children: [
          /* @__PURE__ */ jsx5("div", { className: "time-display", children: formatTime12h(startTime) }),
          /* @__PURE__ */ jsx5("span", { className: "time-arrow", children: "\u2192" }),
          /* @__PURE__ */ jsx5(
            "input",
            {
      ...
      /* @__PURE__ */ jsxs5("div", { className: "form-group", children: [
        /* @__PURE__ */ jsxs5("label", { className: "form-label", children: [
          /* @__PURE__ */ jsx5(AlignLeft, { size: 13 }),
          " Description"
        ] }),
        /* @__PURE__ */ jsx5(
          "textarea",
    ...
    /* @__PURE__ */ jsxs5("div", { className: "modal-footer", children: [
      /* @__PURE__ */ jsx5("button", { className: "btn-secondary", onClick: onClose, children: "Cancel" }),
      /* @__PURE__ */ jsxs5(
        "button",
        {
...
function ReservationCalendar({
  ...
  const [date, setDate] = useState4(/* @__PURE__ */ new Date());
  const staffList = (staffProp == null ? void 0 : staffProp.length) ? staffProp : INITIAL_STAFF;
  const [reservations, setReservations] = useState4(
  ...
  return /* @__PURE__ */ jsxs6("div", { className: "calendar-root", children: [
    /* @__PURE__ */ jsxs6("header", { className: "cal-header", children: [
      /* @__PURE__ */ jsxs6("div", { className: "cal-header-left", children: [
        /* @__PURE__ */ jsx6("div", { className: "cal-logo", children: /* @__PURE__ */ jsxs6("svg", { width: "16", height: "16", viewBox: "0 0 16 16", fill: "none", children: [
          /* @__PURE__ */ jsx6("rect", { x: "1", y: "3", width: "14", height: "11", rx: "2.5", stroke: "currentColor", strokeWidth: "1.2" }),
          /* @__PURE__ */ jsx6("path", { d: "M1 7h14", stroke: "currentColor", strokeWidth: "1.2" }),
          /* @__PURE__ */ jsx6("path", { d: "M5 1v4M11 1v4", stroke: "currentColor", strokeWidth: "1.2", strokeLinecap: "round" }),
          /* @__PURE__ */ jsx6("rect", { x: "3.5", y: "9.5", width: "3", height: "2", rx: "0.5", className: "cal-logo-icon-fill" }),
          /* @__PURE__ */ jsx6("rect", { x: "8.5", y: "9.5", width: "3", height: "2", rx: "0.5", className: "cal-logo-icon-fill", opacity: "0.5" })
        ] }) }),
        /* @__PURE__ */ jsx6("span", { className: "cal-title", children: "SchedulePro" }),
        /* @__PURE__ */ jsx6("span", { className: "cal-enterprise-tag", children: "Enterprise" })
      ] }),
      /* @__PURE__ */ jsxs6("div", { className: "cal-nav", children: [
        /* @__PURE__ */ jsx6("button", { className: "nav-btn", onClick: () => setDate((d2) => subDays(d2, 1)), children: /* @__PURE__ */ jsx6(ChevronLeft, { size: 14 }) }),
        /* @__PURE__ */ jsx6("div", { className: "nav-date", children: /* @__PURE__ */ jsx6("span", { className: "nav-date-text", children: displayDate }) }),
        /* @__PURE__ */ jsx6("button", { className: "nav-btn", onClick: () => setDate((d2) => addDays(d2, 1)), children: /* @__PURE__ */ jsx6(ChevronRight, { size: 14 }) }),
        /* @__PURE__ */ jsx6("button", { className: "nav-today", onClick: () => setDate(/* @__PURE__ */ new Date()), children: "Today" })
      ] }),
      /* @__PURE__ */ jsxs6("div", { className: "cal-header-right", children: [
        /* @__PURE__ */ jsx6("button", { className: "theme-toggle", onClick: () => setTheme((t) => t === "dark" ? "light" : "dark"), children: theme === "dark" ? /* @__PURE__ */ jsxs6(Fragment2, { children: [
          /* @__PURE__ */ jsx6(Sun, { size: 12 }),
          " Light mode"
        ] }) : /* @__PURE__ */ jsxs6(Fragment2, { children: [
          /* @__PURE__ */ jsx6(Moon, { size: 12 }),
          " Dark mode"
        ] }) }),
        /* @__PURE__ */ jsxs6("button", { className: "new-reservation-btn", onClick: () => {
          if (staffList[0]) setModal({ staffId: staffList[0].id, time: "09:00", type: "reservation" });
        }, children: [
          /* @__PURE__ */ jsx6(Plus, { size: 12 }),
          " New Reservation"
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxs6("div", { className: "stats-bar", children: [
      /* @__PURE__ */ jsxs6("div", { className: "stat-item", children: [
        /* @__PURE__ */ jsx6("div", { className: "stat-dot", style: { background: "var(--stat-dot-res)" } }),
        /* @__PURE__ */ jsxs6("div", { className: "stat-values", children: [
          /* @__PURE__ */ jsx6("span", { className: "stat-num", children: totalReservations }),
          /* @__PURE__ */ jsx6("span", { className: "stat-label", children: "Reservations" })
        ] })
      ] }),
      /* @__PURE__ */ jsxs6("div", { className: "stat-item", children: [
        /* @__PURE__ */ jsx6("div", { className: "stat-dot", style: { background: "var(--stat-dot-brk)" } }),
        /* @__PURE__ */ jsxs6("div", { className: "stat-values", children: [
          /* @__PURE__ */ jsx6("span", { className: "stat-num", children: totalBreaks }),
          /* @__PURE__ */ jsx6("span", { className: "stat-label", children: "Breaks" })
        ] })
      ] }),
      /* @__PURE__ */ jsxs6("div", { className: "stat-item", children: [
        /* @__PURE__ */ jsx6("div", { className: "stat-dot", style: { background: "var(--stat-dot-stf)" } }),
        /* @__PURE__ */ jsxs6("div", { className: "stat-values", children: [
          /* @__PURE__ */ jsx6("span", { className: "stat-num", children: staffOnDuty }),
          /* @__PURE__ */ jsx6("span", { className: "stat-label", children: "Staff on duty" })
        ] })
      ] }),
      /* @__PURE__ */ jsxs6("div", { className: "stat-item", children: [
        /* @__PURE__ */ jsx6("div", { className: "stat-dot", style: { background: "var(--stat-dot-util)" } }),
        /* @__PURE__ */ jsxs6("div", { className: "stat-values", children: [
          /* @__PURE__ */ jsxs6("span", { className: "stat-num", children: [
            utilisation,
            "%"
          ] }),
          /* @__PURE__ */ jsx6("span", { className: "stat-label", children: "Utilisation" })
        ] })
      ] }),
      /* @__PURE__ */ jsx6("span", { className: "stat-hint", children: "Click any time slot to schedule \xA0\xB7\xA0 Drag events to reschedule" })
    ] }),
    /* @__PURE__ */ jsx6(DndContext, { sensors, onDragEnd: handleDragEnd, children: /* @__PURE__ */ jsx6("div", { className: "calendar-grid-wrapper", children: /* @__PURE__ */ jsxs6("div", { className: "scroll-container", ref: scrollRef, children: [
      /* @__PURE__ */ jsx6(TimeHeader, {}),
      staffList.map((staff) => /* @__PURE__ */ jsx6(
        StaffRow,
        {
          staff,
